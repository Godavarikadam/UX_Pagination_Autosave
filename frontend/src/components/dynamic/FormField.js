...
// const FormField = ({ field, index, onValueChange, onCheckboxToggle, error }) => {
...
//                     className="border text-[14px] rounded-lg p-2 w-full bg-gray-100 focus:border-[#1E90FF]"
//                 >
...
//                         <label key={j} className="text-[14px] flex gap-2 items-center cursor-pointer rounded-lg">
//                             <input
//                                 type="radio"
//                                 name={`radio-${index}`}
//                                 value={opt.value}
...
//         case 'checkbox':
//             inputElement = (
//                 <div className="flex flex-col gap-1 mt-2 text-sm rounded-lg">
//                     {field.options?.map((opt, j) => {
//                         const checked = currentValue.includes(opt.value);
//                         return (
//                             <label key={j} className="flex gap-2 rounded-lg items-center text-[14px]">
//                                 <input
//                                     type="checkbox"
//                                     checked={checked}
...
//             case 'number': // Added support for unit_price and quantity
//             inputElement = (
//                 <input
//                     type="number"
//                     value={currentValue}
//                     onChange={handleChange}
//                     className="text-[14px] text-black bg-gray-100 border border-gray-100 p-1 rounded-lg w-full focus:outline-none focus:ring-1 focus:ring-[#1E90FF]/40"
//                 />
//             );
//             break;
...
//     return (
//         <div className="bg-white p-2 pl-1 pr-4 rounded-lg  ">

//             <label className="text-black text-[14px] font-medium flex gap-2 mb-2">
//                 {field.label}
...
//             {error && (
//                 <p className="text-red-500 mt-2 text-[12px] font-medium flex items-center gap-1">
//                     {error}
//                 </p>
//             )}
//         </div>
